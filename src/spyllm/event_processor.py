...
class EventProcessor:
    ...
    def __init__(self) -> None:
        logger.info("SpyLLM initializing...")
        ...
        logger.debug("SpyLLM initialized!")
    ...
    async def _start(self) -> None:
        ...
        logger.debug(f"SpyLLM up and running")
        if self._init_event:
    ...
    async def _consume_events(self) -> None:
        ...
        if not self._command_queue or not self._pipe:
            raise RuntimeError("SpyLLM not initialized")
    ...
    async def _shutdown(self) -> None:
        logger.info("Shutting down SpyLLM")
