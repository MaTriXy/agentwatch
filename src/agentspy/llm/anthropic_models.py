...
from agentspy.graph.models import (Edge, GraphExtractor, GraphStructure, LLMNode, ModelGenerateEdge, Node, ToolCallEdge,
                                   ToolNode, graph_extractor_fm)
from agentspy.llm.models import AssistantMessage, SystemMessage, TextContent, Tool, ToolUse, UserMessage
...
class AnthropicRequestModel(GraphExtractor):
    ...
    def extract_graph_structure(self) -> GraphStructure:
        ...
        # Parse all messages, worst case we'll have dups
