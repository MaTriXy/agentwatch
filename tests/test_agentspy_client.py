...
class TestAgentspyClient(unittest.TestCase):
    ...
    def setUp(self, mock_atexit, mock_event, mock_pipe, mock_process):
        ...
        self.mock_agentspy_fd = mock_pipe.return_value[1]
    ...
    @patch('agentspy.pipes.Pipes.write_payload_sync')
    ...
    @patch('agentspy.pipes.Pipes.write_payload_sync')
    @patch('agentspy.pipes.Pipes.read_response')
    def test_send_command_wait(self, mock_read, mock_write):
        ...
        with patch('agentspy.models.Command.from_dict', return_value=Command(
