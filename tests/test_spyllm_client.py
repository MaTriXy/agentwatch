...
class TestSpyLLMClient(unittest.TestCase):
    ...
    def setUp(self, mock_atexit, mock_event, mock_pipe, mock_process):
        ...
        self.mock_spyllm_fd = mock_pipe.return_value[1]
    ...
    @patch('spyllm.pipes.Pipes.write_payload_sync')
    ...
    @patch('spyllm.pipes.Pipes.write_payload_sync')
    @patch('spyllm.pipes.Pipes.read_response')
    def test_send_command_wait(self, mock_read, mock_write):
        ...
        with patch('spyllm.models.Command.from_dict', return_value=Command(
